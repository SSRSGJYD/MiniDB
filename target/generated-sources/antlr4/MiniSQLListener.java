...
public interface MiniSQLListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterRevoke(@NotNull MiniSQLParser.RevokeContext ctx);
	/**
	 * Exit a parse tree produced by the {@code revoke}
	 * labeled alternative in {@link MiniSQLParser#sql}.
	 * @param ctx the parse tree
	 */
	void exitRevoke(@NotNull MiniSQLParser.RevokeContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link MiniSQLParser#clogictree}.
	 * @param ctx the parse tree
	 */
	void enterClogictree(@NotNull MiniSQLParser.ClogictreeContext ctx);
	/**
	 * Exit a parse tree produced by {@link MiniSQLParser#clogictree}.
	 * @param ctx the parse tree
	 */
	void exitClogictree(@NotNull MiniSQLParser.ClogictreeContext ctx);
	/**
	 * Enter a parse tree produced by {@link MiniSQLParser#join}.
	 * @param ctx the parse tree
	 */
	void enterJoin(@NotNull MiniSQLParser.JoinContext ctx);
	/**
	 * Exit a parse tree produced by {@link MiniSQLParser#join}.
	 * @param ctx the parse tree
	 */
	void exitJoin(@NotNull MiniSQLParser.JoinContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link MiniSQLParser#withGrant}.
	 * @param ctx the parse tree
	 */
	void enterWithGrant(@NotNull MiniSQLParser.WithGrantContext ctx);
	/**
	 * Exit a parse tree produced by {@link MiniSQLParser#withGrant}.
	 * @param ctx the parse tree
	 */
	void exitWithGrant(@NotNull MiniSQLParser.WithGrantContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterGrant(@NotNull MiniSQLParser.GrantContext ctx);
	/**
	 * Exit a parse tree produced by the {@code grant}
	 * labeled alternative in {@link MiniSQLParser#sql}.
	 * @param ctx the parse tree
	 */
	void exitGrant(@NotNull MiniSQLParser.GrantContext ctx);
}